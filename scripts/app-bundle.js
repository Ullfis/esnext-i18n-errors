define('app',['exports', 'aurelia-framework', 'aurelia-i18n'], function (exports, _aureliaFramework, _aureliaI18n) {
  ...
  var App = exports.App = (_dec = (0, _aureliaFramework.inject)(_aureliaI18n.I18N, Element), _dec(_class = function () {
    function App(i18n, element) {
    ...
    App.prototype.toggleLanguage = function toggleLanguage() {
      var _this = this;

      if (this.selectedLanguage === 'en') this.selectedLanguage = 'no';else this.selectedLanguage = 'en';

      this.i18n.setLocale(this.selectedLanguage).then(function () {
        _this.reportText = document.getElementById("reportThis").innerHTML;
      });
    };
...
define('resources/index',['exports'], function (exports) {
  ...
  function configure(config) {
    config.globalResources(['./elements/foo-element1', './elements/foo-element2', './elements/foo-element3', './elements/foo-element4']);
  }
});
define('resources/elements/foo-element1',['exports', 'aurelia-framework'], function (exports, _aureliaFramework) {
  'use strict';

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.FooElement1 = undefined;
  ...
  var FooElement1 = exports.FooElement1 = (_class = function FooElement1() {
    _classCallCheck(this, FooElement1);
...
define('resources/elements/foo-element2',['exports', 'aurelia-framework'], function (exports, _aureliaFramework) {
  'use strict';

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.FooElement2 = undefined;
  ...
  var FooElement2 = exports.FooElement2 = (_class = function FooElement2() {
    _classCallCheck(this, FooElement2);

    _initDefineProp(this, 'mdValue', _descriptor, this);
  }, (_descriptor = _applyDecoratedDescriptor(_class.prototype, 'mdValue', [_aureliaFramework.bindable], {
    enumerable: true,
    initializer: null
  })), _class);
});
define('resources/elements/foo-element3',['exports', 'aurelia-framework', 'aurelia-i18n', 'aurelia-event-aggregator'], function (exports, _aureliaFramework, _aureliaI18n, _aureliaEventAggregator) {
  'use strict';

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.FooElement3 = undefined;
  ...
  var FooElement3 = exports.FooElement3 = (_dec = (0, _aureliaFramework.inject)(_aureliaI18n.I18N, Element, _aureliaEventAggregator.EventAggregator), _dec(_class = (_class2 = function FooElement3(i18n, element, ea) {
    var _this = this;

    _classCallCheck(this, FooElement3);
  ...
  }, (_descriptor = _applyDecoratedDescriptor(_class2.prototype, 'mdValue', [_aureliaFramework.bindable], {
    enumerable: true,
...
define('resources/elements/foo-element4',['exports', 'aurelia-framework'], function (exports, _aureliaFramework) {
  'use strict';

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.FooElement4 = undefined;
  ...
  var FooElement4 = exports.FooElement4 = (_dec = (0, _aureliaFramework.bindable)(), (_class = function FooElement4() {
    _classCallCheck(this, FooElement4);

    _initDefineProp(this, 'foovalue', _descriptor, this);
  }, (_descriptor = _applyDecoratedDescriptor(_class.prototype, 'foovalue', [_dec], {
    enumerable: true,
    initializer: function initializer() {
      return 'foo-element4';
    }
...
define('text!app.html', ['module'], function(module) { module.exports = "<template>\n  <h1>${message}</h1>\n\n  <h3>Current language</h3>\n  <p>${selectedLanguage}</p>\n\n  <button click.delegate=\"toggleLanguage()\">Toggle language</button>\n\n<div id=\"reportThis\">\n\n<h3>foo-element1: t=\"[value]FirstName\"</h3>\n<foo-element1 t=\"[value]FirstName\" value=\"s\"></foo-element1>\n\n<h3>foo-element2: t=\"[md-value]FirstName\"</h3>\n<foo-element2 t=\"[md-value]FirstName\" md-value=\"s\"></foo-element2>\n\n<h3>foo-element2: md-value.two-way=\"i18n.tr('FirstName')\"</h3>\n<foo-element2 md-value.two-way=\"i18n.tr('FirstName')\"></foo-element2>\n\n<h3>foo-element3: t=\"[md-value]FirstName\"</h3>\n<foo-element3 t=\"[md-value]FirstName\" md-value=\"s\"></foo-element3>\n\n<h3>foo-element4: t=\"[foovalue]FirstName\"</h3>\n<foo-element4 t=\"[foovalue]FirstName\"></foo-element4>\n\n</div>\n\n  <h3>t=\"FirstName\"</h3>\n  <p t=\"FirstName\"></p>\n\n  <hr/>\n  \n  <pre>\n    <code id=\"report\">${reportText}\n\n    </code>\n  </pre>\n</template>\n"; });
define('text!resources/elements/foo-element1.html', ['module'], function(module) { module.exports = "<template>\n  <p>${value}</p>\n</template>\n"; });
define('text!resources/elements/foo-element2.html', ['module'], function(module) { module.exports = "<template>\n  <p>${mdValue}</p>\n</template>\n"; });
define('text!resources/elements/foo-element3.html', ['module'], function(module) { module.exports = "<template>\n  <p>${mdValue}</p>\n</template>\n"; });
define('text!resources/elements/foo-element4.html', ['module'], function(module) { module.exports = "<template>\n  <p>${foovalue}</p>\n</template>\n"; });
